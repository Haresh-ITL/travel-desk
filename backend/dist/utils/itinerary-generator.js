...
exports.generateItineraryHTML = generateItineraryHTML;
function generateItineraryHTML(data) {
    ...
    const flightInfo = typeof data.flight === 'string'
        ...
        : data.flight
            ...
            : null;
    const hotelInfo = typeof data.hotel === 'string'
        ? { display: data.hotel }
        : data.hotel
            ? {
            ...
            : null;
    const cabInfo = typeof data.cab === 'string'
        ? { display: data.cab }
        : data.cab
            ? {
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div class="hotel-card">
                    <div class="hotel-name">🏨 ${hotelInfo && typeof hotelInfo === 'object' && 'name' in hotelInfo ? hotelInfo.name : ((hotelInfo === null || hotelInfo === void 0 ? void 0 : hotelInfo.display) || 'Hotel')}</div>
            ...
            <div class="section">
                ...
                <div class="cab-card">
                    <div class="cab-provider">🚕 ${cabInfo && typeof cabInfo === 'object' && 'provider' in cabInfo ? cabInfo.provider : ((cabInfo === null || cabInfo === void 0 ? void 0 : cabInfo.display) || 'Cab Service')}</div>
