...
class ChatbotService {
    ...
    async getPerplexityResponse(messages) {
        var _a, _b, _c;
        if (!env_1.env.perplexityApiKey) {
        ...
        let modelName = (env_1.env.perplexityModel || "sonar-pro").trim();
        ...
        const response = await fetch(url, {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${env_1.env.perplexityApiKey}`,
        ...
        return ((_c = (_b = (_a = data.choices) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content) || "I'm sorry, I couldn't generate a response. Please try again.";
    }
